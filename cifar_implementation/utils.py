...
def prepare_folders(args):
    ...
    folders_util = [args.path_history, args.path_model,
                    os.path.join(args.path_history, args.store_name),
                    os.path.join(args.path_model, args.store_name)]
...
def save_checkpoint(args, state, is_best):
    ...
    filename = '%s/%s/ckpt.pth.tar' % (args.path_model, args.store_name)
